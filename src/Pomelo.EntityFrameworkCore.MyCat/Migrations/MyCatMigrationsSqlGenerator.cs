...
{
    public class MyCatMigrationsSqlGenerationHelper : MigrationsSqlGenerator
    {
        public MyCatMigrationsSqlGenerationHelper(
        ...
        protected override void Generate([NotNull] MigrationOperation operation, [CanBeNull] IModel model, [NotNull] MigrationCommandListBuilder builder)
        {
            ...
            var createDatabaseOperation = operation as MyCatCreateDatabaseOperation;
            ...
            var dropDatabaseOperation = operation as MyCatDropDatabaseOperation;
            if (dropDatabaseOperation is MyCatDropDatabaseOperation)
            {
        ...
        {
            throw new NotSupportedException("MyCat doesn't support sequence operation.");
        }
